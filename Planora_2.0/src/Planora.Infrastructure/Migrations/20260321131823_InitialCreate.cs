    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupDisciplineLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupDisciplineLists_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupDisciplineLists_Subjects_SubjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupDisciplineLists_GroupId",
                table: "GroupDisciplineLists",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupDisciplineLists_SubjectId",
                table: "GroupDisciplineLists",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_DayOfWeek_TimeSlotId_WeekType",
                table: "Schedules",
                columns: new[] { "DayOfWeek", "TimeSlotId", "WeekType" });
